...
namespace vk {
    vk_renderpass::vk_renderpass(const vk_renderpass_options& p_renderpass_options) : m_renderpass_options(p_renderpass_options){
        ...
        console_log_fatal("attachments.size() = {}", p_renderpass_options.attachments.size());
        console_log_fatal("subpass_deps.size() = {}", p_renderpass_options.subpass_descriptions.size());
        console_log_fatal("subpassCount = {}", static_cast<uint32_t>(m_renderpass_options.subpass_descriptions.size()));
        ...
        vk_check(res, "vkCreateRenderPass", __FUNCTION__);
    }
