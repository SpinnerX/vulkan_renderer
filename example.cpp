...
private:
    ...
    void initVulkan() {
        ...
        // // init_info.QueueFamily = graphicsQue;
		...
		// m_Dset.resize(swapChainImages.size());
		// for (uint32_t i = 0; i < swapChainImages.size(); i++)
		// 	m_Dset[i] = ImGui_ImplVulkan_AddTexture(textureSampler, swapChainImageViews[i], VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
    }
	...
	{
		m_ImGuiFramebuffers.resize(swapChainImages.size());
